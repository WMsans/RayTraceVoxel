...
float4 _SDFChunkAtlasParams;
// x: resolution (32), y: numChunks (16)
...
// 5. Scale Distance
            // Texture stores 'local' SDF in Voxel Units (0..Resolution).
            // We must convert to Normalized Units (0..1) then to World Units.
d = (sampledSDF / _SDFChunkAtlasParams.x) * minScale;
